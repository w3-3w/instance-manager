...
module.exports = {
   ...
   */
  async startInstances(scheduledOnly, ...instanceNames) {
   ...
   */
  async stopInstances(scheduledOnly, ...instanceNames) {
    const instances = await getInstances(scheduledOnly, ...instanceNames);
   ...
   */
  async displayInstances(scheduledOnly, ...instanceNames) {
    const instances = await getInstances(scheduledOnly, ...instanceNames);
    if (instances.size < 1) {
